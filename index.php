...
-->
 ...
 <style  type="text/css">
	...
	<!-- spacer section -->
	<section class="spacer bg3" id="works">
		<div class="container">
			<div class="row" style="margin:auto;">
				 <div class="col-md-12" style="text-align:center;margin-left:150px;">
                        <h2 class="title" data-animate="fadeInDown">Por que confiar em nós?</h2>

                        <p class="lead">5 Motivos para confiar: </p>
                        ...
                        <div class="row">
                            <div class="span3 animated-fast flyIn">
                                <div class="service-box">
                                     ...
                                     <h3 class="heading">1 -  Respeito ao cliente.</h3>
                                <p></p>
                                </div>
                            </div>
                            <div class="span3 animated-fast flyIn">
                                ...
                                <h3 class="heading"> 2. Parceria com grandes empresas.</h3>
                                <p></p>
                                </div>
                            </div>
                            <div class="span3 animated-fast flyIn">
                                ...
                                <h3 class="heading"> 3. Ética e transparência.</h3>
                                <p> </p>
                       ...
                       <div class="row" style="text-align:center;">
                            <div class="span3 animated-fast flyIn">
                                ...
                                <h3 class="heading">4. Ambiente seguro e rápido.</h3>
                                <p></p>
                            </div>
                                </div>
                            <div class="span3 animated-fast flyIn">
                                <div class="service-box">
                                    ...
                                    <h3 class="heading">5. Inteligência, tecnologia e segurança da informação.</h3>
                                    <p> </p>
                                </div>
                            </div>
                           <div class="span3 animated-fast flyIn">
				...
				<div class="span3 img_sobre">
					<div class="home-post">
						...
						<div class="entry-content">
							...
							<a class="more" data-toggle="modal" data-target="#modalBlog<?php echo $rs['id_blog']; ?>">Continuar Lendo</a>
						</div>
					</div>
				</div>
                  <!-- Inicio Modal -->
                    <div class="modal fade" id="modalBlog<?php echo $rs['id_blog']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title text-center" id="myModalLabel"><?php echo $rs['titulo']; ?></h4>
                                </div>
                                <div class="modal-body" style="text-align:center;">
                                    <p><img style="width:200px;" src="<?php echo $rs['imagem']; ?>"> </p>

                                    <p><?php echo $rs['resumo']; ?> <?php echo $rs['detalhes']; ?></p>												<p><?php echo $rs['data']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div class="row">
				<div class="span12">
					<div class="cform" id="contact-form">
						...
						<form  role="form" class="contactForm"  method="POST" action="sendemail.php" accept-charset="UTF-8">
							<div class="row">
								<div class="span6">
								...
								<div class="span6">
									<div class="field message form-group">
										<textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Digite aqui sua mensagem"></textarea>
										<div class="validation"></div>
									</div>
       ...
       <div class="col-sm-3">
        ...
        <div class="col-sm-9 text-right">
            ...
            <div class="duvidas" style="text-align:center">
                ...
                <!-- <a href="javascript:" onclick="Start.abrirPopupAtendimento();"><i class="sprite-icon-chat-xs"></i> Chat Online</a> -->
                <i class="sprite-icon-envelope"></i> atendimento@creditovc.com.br<br>
                <i class="sprite-icon-whatsapp"></i> WhatsApp 11 95825-1263<br>
            </div>
        </div>
